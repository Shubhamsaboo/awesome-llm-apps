...
class AnalyzedPost(BaseModel):
    ...
    categories: List[Category] = Field(
        ..., description="List of categories that best describe this post"
    )
    tags: List[str] = Field(
        ..., description="List of relevant tags or keywords extracted from the post"
    )
    reasoning: str = Field(
        ..., description="Brief explanation of why these sentiments and categories were assigned"
    )
...
SENTIMENT_AGENT_DESCRIPTION = (
    "Expert sentiment analyzer and content categorizer for social media posts."
)
