...
class CustomZoomTool(ZoomTool):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            account_id=account_id, client_id=client_id, client_secret=client_secret, name=name
        )
...
def main() -> None:
    ...
    email = st.text_input(
        "Candidate's email address", value=st.session_state.candidate_email, key="email_input"
    )
            ...
            with st.spinner("Analyzing your resume..."):
                ...
                if resume_analyzer and email_agent:
                    ...
                    is_selected, feedback = analyze_resume(
                        st.session_state.resume_text, role, resume_analyzer
                    )
                    print(
            ...
            with st.spinner("🔄 Processing your application..."):
                try:
                    ...
                    with st.status("📧 Sending confirmation email...", expanded=True) as status:
                        ...
                        send_selection_email(email_agent, st.session_state.candidate_email, role)
                    ...
                    with st.status("📅 Scheduling interview...", expanded=True) as status:
                        ...
                        schedule_interview(
                            scheduler_agent, st.session_state.candidate_email, email_agent, role
                        )
