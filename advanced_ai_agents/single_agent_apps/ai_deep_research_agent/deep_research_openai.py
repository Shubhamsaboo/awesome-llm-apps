...
st.set_page_config(
    page_title="OpenAI Deep Research Agent", page_icon="📘", layout="wide"
)
...
st.markdown(
    "This OpenAI Agent from the OpenAI Agents SDK performs deep research on any topic using Firecrawl"
)

# Research topic input
research_topic = st.text_input(
    "Enter your research topic:", placeholder="e.g., Latest developments in AI"
)
...
async def deep_research(
    query: str, max_depth: int, time_limit: int, max_urls: int
) -> Dict[str, Any]:
    """
...
if st.button(
    "Start Research",
    disabled=not (openai_api_key and firecrawl_api_key and research_topic),
):
