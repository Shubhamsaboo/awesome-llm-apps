...
class Tree:
    ...
    def get_appwise_nodes(
        ...
        apps = {
            "Taskbar": visible_apps.pop("Taskbar"),
            "Program Manager": visible_apps.pop("Program Manager"),
        }
        if visible_apps:
    ...
    def annotate(self, nodes: list[TreeElementNode]) -> Image:
        ...
        for label, node in enumerate(nodes):
            ...
            adjusted_box = (
                box.left + padding,
                box.top + padding,  # Adjust top-left corner
                box.right + padding,
                box.bottom + padding,  # Adjust bottom-right corner
            )
            ...
            label_x1 = (
                right - label_width
            )  # Align the right side of the label with the right edge of the box
            label_y1 = (
                top - label_height - 4
            )  # Place the label just above the top of the bounding box, with some padding
