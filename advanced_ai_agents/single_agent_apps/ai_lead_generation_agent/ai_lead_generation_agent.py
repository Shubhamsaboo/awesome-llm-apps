...
def create_google_sheets_agent(composio_api_key: str, openai_api_key: str) -> Agent:
    ...
    google_sheets_tool = composio_toolset.get_tools(actions=[Action.GOOGLESHEETS_SHEET_FROM_JSON])[
        0
    ]
...
def write_to_google_sheets(
    flattened_data: List[dict], composio_api_key: str, openai_api_key: str
) -> str:
