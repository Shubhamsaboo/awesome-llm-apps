...
analysis_agent = Agent(
    name="Analysis Agent", instructions="You analyze information and provide insights."
)
...
async def custom_spans_demo():
    ...
    with trace("Document Processing Workflow") as doc_trace:
        ...
        with custom_span("AI Processing") as ai_span:
            ...
            ai_span.add_event(
                "Processing complete",
                {"output_length": len(result.final_output), "model_used": "gpt-4o"},
            )
...
async def hierarchical_spans():
    ...
    with trace("E-commerce Order Processing") as order_trace:
        ...
        with custom_span("AI Recommendation Generation") as rec_span:
            ...
            rec_span.add_event(
                "Recommendations generated", {"count": 3, "confidence": 0.89}
            )
...
async def trace_metadata_demo():
    ...
    with trace(
        ...
        result1 = await Runner.run(research_agent, "How do I reset my password?")
...
async def main():
    ...
    print(
        "Check the OpenAI Traces dashboard to see your custom workflow visualizations"
    )
