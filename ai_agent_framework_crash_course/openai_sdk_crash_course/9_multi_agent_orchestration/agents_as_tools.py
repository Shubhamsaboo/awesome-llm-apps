...
async def direct_orchestration_comparison():
    ...
    research_result = await Runner.run(
        research_agent, f"Research trends and predictions about: {topic}"
    )
    ...
    editing_result = await Runner.run(
        editing_agent, f"Edit and improve this article: {writing_result.final_output}"
    )
...
async def main():
    ...
    print(
        "Agents as tools enable sophisticated workflow orchestration with intelligent coordination"
    )
