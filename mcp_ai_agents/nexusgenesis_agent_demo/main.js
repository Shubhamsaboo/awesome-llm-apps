...
async function main() {
  ...
  console.log('║  Signatures are PQC (quantum-resistant).                ║');
  console.log('║  A human can always take control back.                  ║');
  console.log('║                                                         ║');
  console.log('║  Install: npm install nexusgenesis-agent-sdk            ║');
  console.log('║  MCP:     npx nexusgenesis-agent-mcp                    ║');
  console.log('║  Repo:    https://github.com/nexus-genesis/             ║');
  console.log('╚══════════════════════════════════════════════════════════╝');
  console.log('');
}
