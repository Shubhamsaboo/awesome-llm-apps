...
def process_pdf_file(
    ...
    try:
        ...
        valid_paths = [
            path for i, path in enumerate(page_image_paths) if page_embeddings[i] is not None
        ]
            ...
            try:
                ...
                if file_type == "application/pdf":
                    ...
                    if pdf_page_paths and pdf_page_embeddings:
                        ...
                        if unique_new_paths:
                            indices_to_add = [
                                i for i, p in enumerate(pdf_page_paths) if p in unique_new_paths
                            ]
        ...
        with st.spinner("Finding relevant image..."):
            ...
            if len(st.session_state.image_paths) != st.session_state.doc_embeddings.shape[0]:
                ...
                top_image_path = search(
                    question, co, st.session_state.doc_embeddings, st.session_state.image_paths
                )
