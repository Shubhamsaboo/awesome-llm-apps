...
技术栈:
  ...
  - Neo4j: 图数据库，存储中医知识图谱
  - DeepSeek: 大语言模型（兼容 OpenAI API）
  - FAISS + bge-large-zh-v1.5: 语义向量匹配

使用方式:
  1. 启动 FastAPI 服务: python fastapi_app/main.py
  2. 启动本前端: streamlit run streamlit_app/app.py
"""
...
# 向上两级: streamlit_app/app.py → streamlit_app → 项目根目录
