...
LangGraph 工作流路由：
  - 小红书发布意图 → 文案生成 → 图片生成 → 校验 → 发布 → Markdown 输出
  - 中医相关问题 → 实体抽取 → FAISS 语义匹配 → Cypher 查询 → Neo4j 回答
  - 非中医问题 → LLM 直接回答
...
from __004__langgraph_more_nodes.langgraph_more_nodes import zhongyi_response, graph
...
NODE_PROGRESS_MAP = {
    # —— 小红书发布链路 ——
    "xiaohongshu_publish_intent_node": "🔍 正在识别发布意图...",
    "text_generate_node": "✍️ 正在生成小红书文案...",
    "image_generator_node": "🎨 正在生成配图...",
    "check_text_image_node": "✅ 正在校验内容完整性...",
    "auto_publish_xiaohongshu_node": "🚀 正在自动发布到小红书...",
    "generate_markdown_node": "📄 正在生成结果页面...",
    # —— 中医知识图谱问答链路 ——
