...
def main():
    ...
    # Live research: optionally show planned queries or source list if you expose it
    with tab_live:
        st.write("Running deep search…")
        # Call backend
        result = deep_search_api_first(topic=topic, days=days, max_items=max_items)
        # show raw candidate list or search_log if available
    ...
    with tab_brief:
        ...
        if not items:
            ...
            # Render executive summary and bullets
