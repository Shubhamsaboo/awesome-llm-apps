                ...
                try:
                    ...
                    with st.spinner("🤗 Getting empathetic support..."):
                        ...
                        response = therapist_agent.run(
                            therapist_prompt, images=all_images
                        )
                    ...
                    with st.spinner("📅 Creating your recovery plan..."):
                        ...
                        response = routine_planner_agent.run(
                            routine_prompt, images=all_images
                        )
                    ...
                    with st.spinner("💪 Getting honest perspective..."):
                        ...
                        response = brutal_honesty_agent.run(
                            honesty_prompt, images=all_images
                        )
                    ...
                    st.error(
                        "An error occurred during analysis. Please check the logs for details."
                    )
            else:
                st.warning(
                    "Please share your feelings or upload screenshots to get help."
                )
        else:
