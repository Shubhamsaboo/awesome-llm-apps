...
def store_embeddings(
    client: QdrantClient, embedding_model: TextEmbedding, documents: List, collection_name: str
) -> None:
...
async def process_query(
    ...
    try:
        ...
        return {
            ...
            "sources": [
                r.payload.get("file_name", "Unknown Source") for r in search_results if r.payload
            ],
        }
...
def main() -> None:
    ...
    st.info(
        "Get voice-powered answers to your documentation questions by configuring your API keys and uploading PDF documents. Then, simply ask questions to receive both text and voice responses!"
    )
