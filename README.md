...
*   [🧠 Advisor Orchestrator Worker](agent_skills/advisor-orchestrator-worker/) - Five-tier meta loop: advisory cost estimate, disagreement path pricing for Papa tie-breaks, mandatory Fable advisor, Gemini workers
