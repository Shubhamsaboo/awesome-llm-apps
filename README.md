...
*   [LLM Daily Review](https://tokenstree.eu) - Automated LLM-powered daily reviewer and scorer of AI tools from Hacker News. Tests each tool in isolated Docker containers and scores across 11 criteria (novelty, UX, security, documentation, etc.). Open source.
