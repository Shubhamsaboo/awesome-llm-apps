...
*   [🕵️ Cynative - Open Cybersecurity Agent](https://github.com/cynative/cynative) <sub>↗ external</sub> - Deep security research for AWS, GCP, Azure, K8s, GitHub and GitLab. Read-only by construction.
