...
|*   [🔎 BundleDex](https://bundledex.net) <sub>↗ external</sub> - Directory of 381 OKF (Open Knowledge Format) bundles for AI agents. Search, browse, and discover knowledge bundles with MCP support.
