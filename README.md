...
*   [🏗️ Zero Engineer](https://github.com/sstklen/zero-engineer) — Production API platform (30+ APIs) built by a non-engineer using Claude Code + Codex + Gemini as a 3-agent team
