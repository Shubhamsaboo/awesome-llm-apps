...
*   [🛡️ BodAIGuard](https://github.com/AxonLabsDev/BodAIGuard) - Universal AI agent safety guardrail with 42 block rules, 31 confirm rules, 4 enforcement modes, and prompt injection detection
