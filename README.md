...
*   [📄 AI Layout-Preserving PDF Translator](advanced_ai_agents/single_agent_apps/ai_pdf_translator_agent/) - Translate complex documents while preserving 1:1 vector layout, tables, and typography with LLMs and Streamlit
