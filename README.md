...
*   [🦁 claude-node - Python subprocess bridge for Claude Code CLI](https://github.com/claw-army/claude-node) - Embed Claude Code into Python backends and agents via stream-json.
