...
*   [🧊 Frostbyte MCP Server — 13-tool MCP server for Claude, Cursor & Windsurf (IP geolocation, crypto prices, web scraping, screenshots, DNS, code execution, PDF generation, web search & more)](https://github.com/OzorOwn/frostbyte-mcp)
