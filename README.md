...
*   [🐋 Orkas - Local-First Multi-Agent Desktop App](https://github.com/Orkas-AI/Orkas) <sub>↗ external</sub> - Desktop AI workforce where a Commander coordinates specialist agents while conversations, files, and model keys stay local
