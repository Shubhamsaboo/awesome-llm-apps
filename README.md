...
- [Mysti](https://github.com/DeepMyst/Mysti) - Multi-agent AI coding assistant for VS Code. Supports multiple LLM backends with brainstorm mode where agents collaborate and deliver solutions.
