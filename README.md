...
*   [🚌 Harness Agent Builder](agent_skills/harness-agent-builder/) - Scaffolds durable backend agents with correct harness wiring, triggers, and runtime model resolution
