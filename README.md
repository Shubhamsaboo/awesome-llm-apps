...
*   [🛡️ Cordum](https://github.com/cordum-io/cordum) - Safety-first agent orchestration platform with pre-dispatch policy evaluation, output scanning, job scheduling, workflow engine, and native MCP server.
