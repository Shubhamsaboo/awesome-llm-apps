...
*   [🔐 NexusGenesis MCP Server](https://github.com/nexus-genesis/nexusgenesis/tree/master/mcp-server) <sub>↗ external</sub> - Agent key security & coordination — post-quantum self-custody keys (Dilithium2) and human takeover for LLM agents. Install: `npx nexusgenesis-agent-mcp`
