...
- [📊 AI Model Benchmarks 2026](https://github.com/LARIkoz/ai-model-benchmarks) - Optimize agent/pipeline routing with structured model comparison data. 119 models, per-score freshness dates, daily auto-updates, task routing matrix. MIT.
