...
*   [⚡ Entroly Context Engineering Engine](https://github.com/juyterman1000/entroly) - Zero-friction local daemon reducing context window size by 78% for coding agents (Cursor, Claude Code) using Rust knapsack optimization
