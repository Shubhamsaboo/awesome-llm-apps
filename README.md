...
*   [🤝 Pinchwork - Agent-to-Agent Task Marketplace](https://github.com/anneschuth/pinchwork) - MCP server that lets AI agents delegate tasks, pick up work, and earn credits across a marketplace of specialist agents.
