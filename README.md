...
- [🔀 OmniRoute](https://github.com/diegosouzapw/OmniRoute) - Self-hostable AI gateway with 4-tier automatic fallback routing across 36+ providers (Claude Code, Codex, Gemini CLI, DeepSeek, Groq, NVIDIA NIM, etc.). Unified OpenAI-compatible API with quota tracking, multi-account support, and zero-cost fallback to free tiers
