...
*   [🖥️ Computer Use MCP Agent](mcp_ai_agents/computer_use_mcp_agent/) - Control a real Windows desktop with natural language: screenshots, OCR, mouse, keyboard, and window management over MCP
