...
*   [🔐 AgentMesh](https://github.com/imran-siddique/agent-mesh) - Trust layer for multi-agent systems with identity, delegation chains, and compliance automation (SOC2, HIPAA, EU AI Act)
