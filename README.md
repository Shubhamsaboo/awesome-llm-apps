...
*   [🛡️ Agent OS](https://github.com/imran-siddique/agent-os) - Kernel architecture for AI agent governance with deterministic policy enforcement (integrates with LangChain, CrewAI, MCP)
