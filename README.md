...
*   [♾️ KubeStellar Console (kc-agent MCP)](https://github.com/kubestellar/console) - Multi-cluster Kubernetes management dashboard with AI-powered workload distribution
