...
| [🧪 falsify](https://github.com/263311487-ux/falsify) <sub>↗ external</sub> | A scientific thinking protocol for AI agents: falsification-first — hypothesis, attempt to break it, evidence, calibrated conclusion. No verdict without a falsifiable hypothesis. Ships a live browser checker, bias catalog, mental-model references, and runnable evals (MIT) |
