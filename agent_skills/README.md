...
| [🛫 runway-monte-carlo](runway-monte-carlo/) | Simulates cash runway as a distribution instead of a number — thousands of burn/revenue paths by a bundled zero-dependency script, reporting P10/P50/P90 runway, a month-by-month death curve, and a real .xlsx whose assumption cells recalculate live |
