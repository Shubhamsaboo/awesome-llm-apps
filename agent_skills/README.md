...
| [🔁 flip-flop-detector](flip-flop-detector/) | Walks a file's full git history to find code that keeps getting rewritten back and forth between prior states, ranking indecision hotspots by flip count, involved authors, and time span — evidence of unresolved disagreement `git blame` alone can't show |
