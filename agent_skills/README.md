...
| [🎯 test-impact-mapper](test-impact-mapper/) | Maps a local git diff to an evidence-backed shortlist of likely tests to run, citing conventional path pairs, reverse imports, and mentioned symbols |
