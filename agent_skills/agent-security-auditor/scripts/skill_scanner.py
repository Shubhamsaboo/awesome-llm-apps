...
Canonical copy: agent_skills/agent-security-auditor/scripts/skill_scanner.py
(this file, shipped with the installable skill). CI keeps a trampoline at
agent_skills/evals/tools/skill_scanner.py that imports this module, so a local
`python3 scripts/audit.py` run and the GitHub Actions security-scan job cannot
drift.
