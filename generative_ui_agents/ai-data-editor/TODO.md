# AI Data Editor — Wishlist

## What Works Today
- [x] Agent queries real SQLite DB (50 accounts, 740 usage rows, 200 invoices)
- [x] Natural language → SQL → structured results
- [x] Auto-loads dashboard on page open
...
- [x] Inline editing (click field → edit → agent proposes mutation)
